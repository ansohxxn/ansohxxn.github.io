...
<details>
<summary>📜archive-single2.html 펼쳐서 보기 (Click)</summary>
<div markdown="1">

![image](https://user-images.githubusercontent.com/42318591/116509550-7e5b3c00-a8fe-11eb-9e18-46450c18e633.png)

나는 제목, 날짜, 카테고리, 태그가 위와 같이 한 줄로 붙은 상태로 나열하고 싶어 📜archive-single.html 를 좀 수정하여 만든 📜archive-single2.html 를 사용하였다. 제 방식과 비슷하게 나열하고 싶으신 분들은 아래 📜archive-single2.html 코드를 참고해주세요 :) 
